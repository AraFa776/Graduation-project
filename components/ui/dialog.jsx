...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "min-w-0 break-words font-heading text-base leading-snug font-medium",
        className
      )}
      {...props} />
  );
